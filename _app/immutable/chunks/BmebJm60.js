...
var H = (t, e, n) =>
  e in t
    ...
    : (t[e] = n);
var z = (t, e, n) => H(t, typeof e != "symbol" ? e + "" : e, n);
import {
  n as w,
  E as W,
  F as X,
...
let F = Q ? () => window.performance.now() : () => Date.now(),
  L = Q ? (t) => requestAnimationFrame(t) : w;
const E = new Set();
function T(t) {
  E.forEach((e) => {
...
`;
  ...
  const d =
    ...
    g = W(t),
    { stylesheet: h, rules: o } = j.get(g) || lt(g, t);
  o[f] ||
...
function N(t, e) {
  const n = (t.style.animation || "").split(", "),
    ...
    u = n.length - s.length;
  u && ((t.style.animation = s.join(", ")), (C -= u), C || ct());
}
function ct() {
  L(() => {
    C ||
...
function wt(t, e, n) {
  ...
  return {
    start() {
      f || ((f = !0), N(t), M(u) ? ((u = u(s)), B().then(d)) : d());
    },
    invalidate() {
      f = !1;
    },
...
function bt(t, e, n) {
  ...
  function r() {
    ...
    O(() => v(t, !1, "start")),
      ...
      U((m) => {
        if (a) {
          if (m >= $) return h(0, 1), v(t, !1, "end"), --i.r || S(i.c), !1;
          if (m >= _) {
            const y = g((m - _) / f);
            h(1 - y, y);
          }
          ...
          U((P) => {
            if (
              (c &&
                ...
                (c = null),
                v(t, i.b, "start"),
                x && (f(), (r = I(t, l, i.b, i.duration, 0, m, a.css)))),
              i)
            ) {
              if (P >= i.end)
                y((l = i.b), 1 - l),
                  v(t, i.b, "end"),
                  c || (i.b ? f() : --i.group.r || S(i.group.c)),
                  (i = null);
              else if (P >= i.start) {
                const V = P - i.start;
                (l = i.a + i.d * m(V / i.duration)), y(l, 1 - l);
              }
            }
            return !!(i || c);
          }));
...
function Mt(t, e, n, s, u, a, l = null, i = [-1]) {
  const c = tt;
  J(t);
  const r = (t.$$ = {
    fragment: null,
