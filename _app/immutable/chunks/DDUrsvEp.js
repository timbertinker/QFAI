...
var F = (t, e, n) =>
  e in t
    ...
    : (t[e] = n);
var f = (t, e, n) => F(t, typeof e != "symbol" ? e + "" : e, n);
function G() {}
const ut = (t) => t;
function I(t, e) {
    ...
    const a = e[o].claim_order,
      u =
        (s > 0 && e[n[s]].claim_order <= a
          ? s + 1
          : K(1, s, (W) => e[n[W]].claim_order, a)) - 1;
    i[o] = n[u] + 1;
    const H = u + 1;
    (n[H] = o), (s = Math.max(H, s));
  }
  const c = [],
    r = [];
  let l = e.length - 1;
  ...
  return (
    s
      ? ((i.src =
        ...
        (c = C(window, "message", (r) => {
          r.source === i.contentWindow && e();
        })))
      : ((i.src = "about:blank"),
        (i.onload = () => {
          (c = C(i.contentWindow, "resize", e)), e();
        })),
    P(t, i),
    () => {
...
function ot() {
  ...
  do {
    ...
    for (v(null), h.length = 0, d = 0; L.length; ) L.pop()();
